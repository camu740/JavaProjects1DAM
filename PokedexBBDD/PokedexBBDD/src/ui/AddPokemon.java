...
public class AddPokemon {
								...
								for (Sexo s : Sexo.values()) {
									if (s.equals(cbSexo.getSelectedItem())) {
										...
										try {
											...
											Pokemon p = new Pokemon(Integer.valueOf(tfNumeroPokemon.getText()),
													t.toString(), tfNombrePokemon.getText(), s.toString(),
	...
	private void showPokemon() {
		...
		tfNombrePokemon.setText(lista_pokemons.get(PokedexView.count).getName());
		tfNumeroPokemon.setText(Integer.toString(lista_pokemons.get(PokedexView.count).getNumeroPokedex()));
		...
		cbTipo.setSelectedItem(lista_pokemons.get(PokedexView.count).getTipo());
		cbSexo.setSelectedItem(lista_pokemons.get(PokedexView.count).getTipo());
